...
const Contact = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await fetch("https://portfolio-backend-2eis.onrender.com/api/contact", {
                method: "POST",
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6">
                ...
                >
                    ...
                    <p className="text-gray-500 dark:text-gray-400 max-w-xl">
                        Get in touch with me. I will get back to you as soon as
                        possible.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mb-8">
                        Fill out the form below and I will get back to you as
                        soon as possible.
                    </p>
                ...
                focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white transition"
                        ...
                        <AnimatePresence>
                            {status && (
                                <motion.div
                                    key={status.message} // important for AnimatePresence
                                        ...
                                        {status.type !== "success" && (
                                            <>
                                                ...
                                                <a
                                                    ...
                                                    className="text-black   dark:text-white hover:text-red-500 transition-colors underline"
                                                >
                                                    EMAIL
                                                </a>
                                            </>
